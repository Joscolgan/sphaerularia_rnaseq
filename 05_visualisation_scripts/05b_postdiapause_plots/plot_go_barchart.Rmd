...
## Generate plot:
postdiapause_terms_plot <- ggbarplot(combined_terms,
                                           x = "updated_terms",
...
postdiapause_terms_plot <- postdiapause_terms_plot +
...
## Save plot:
save(postdiapause_terms_plot,
     file = "./results/postdiapause_go_term_plot.Rdata")

## Save picture:
ggsave(file = "results/postdiapause_go_terms_barchart.png",
       height = 5,
       width = 10)
```
