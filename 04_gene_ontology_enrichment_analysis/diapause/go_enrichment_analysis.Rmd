...
## Step One
## GO annotations
gene_to_go_mapping_file <- "./bter_drosophila_orthologues_go_term_database_for_topgo.txt"

## file of significant genes (1 column file: i.e. gene id) file:
directory <- "./input/"
de_genes_file <- paste(directory, "de_genes_for_topGO_diapause.txt", sep = "")

output_directory <- "results/output_node_20_raw"
